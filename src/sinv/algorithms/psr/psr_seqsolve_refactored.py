...
def produce_schur_central(A: np.ndarray,
    ...
    for i in range(bottom_blockrow-2, top_blockrow+1, -1):
        ...
        G[i_rowindice:i_rowindice, im1_rowindice:i_rowindice] =\
...
def psr_seqsolve_refactored(A: np.ndarray, 
    ...
    if comm_rank == 0:
        ...
        #utils.vizu.vizualiseDenseMatrixFlat(G_schur, "G_schur process " + str(comm_rank))
    ...
    utils.vizu.vizualiseDenseMatrixFlat(G, "G process " + str(comm_rank))
