...
def test_bcr_parallel_symmat_reel_1():
    matrice_size = 2
    blocksize    = 1
...
@pytest.mark.mpi(min_size=2)
def test_bcr_parallel_symmat_reel_2():
    matrice_size = 4
    blocksize    = 2
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)
def test_bcr_parallel_symmat_reel_3():
    matrice_size = 6
    blocksize    = 3
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)            
def test_bcr_parallel_symmat_reel_4():
    matrice_size = 3
    blocksize    = 1
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)            
def test_bcr_parallel_symmat_reel_5():
    matrice_size = 6
    blocksize    = 2
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)            
def test_bcr_parallel_symmat_reel_6():
    matrice_size = 9
    blocksize    = 3
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)
def test_bcr_parallel_symmat_reel_7():
    matrice_size = 128
    blocksize    = 8
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)        
def test_bcr_parallel_symmat_reel_8():
    matrice_size = 128
    blocksize    = 16
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=2)        
def test_bcr_parallel_symmat_reel_9():
    matrice_size = 128
    blocksize    = 16
    bandwidth    = np.ceil(blocksize/2)
...
if __name__ == '__main__':
    test_bcr_parallel_symmat_reel_1()
    test_bcr_parallel_symmat_reel_2()
    test_bcr_parallel_symmat_reel_3()
    test_bcr_parallel_symmat_reel_4()
    test_bcr_parallel_symmat_reel_5()
    test_bcr_parallel_symmat_reel_6()
    test_bcr_parallel_symmat_reel_7()
    test_bcr_parallel_symmat_reel_8()
    test_bcr_parallel_symmat_reel_9()
