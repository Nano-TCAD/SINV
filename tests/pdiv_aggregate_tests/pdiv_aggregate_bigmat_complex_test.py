...
def test_pdiv_aggregate_bigmat_complex_1():
    matrice_size = 1000
    blocksize    = 10
...
def test_pdiv_aggregate_bigmat_complex_2():
    matrice_size = 1000
    blocksize    = 40
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
def test_pdiv_aggregate_bigmat_complex_3():
    matrice_size = 1000
    blocksize    = 100
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
def test_pdiv_aggregate_bigmat_complex_4():
    matrice_size = 2500
    blocksize    = 10
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
def test_pdiv_aggregate_bigmat_complex_5():
    matrice_size = 2500
    blocksize    = 100
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
def test_pdiv_aggregate_bigmat_complex_6():
    matrice_size = 2500
    blocksize    = 250
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
if __name__ == '__main__':
    test_pdiv_aggregate_bigmat_complex_1()
    test_pdiv_aggregate_bigmat_complex_2()
    test_pdiv_aggregate_bigmat_complex_3()
    test_pdiv_aggregate_bigmat_complex_4()
    test_pdiv_aggregate_bigmat_complex_5()
    test_pdiv_aggregate_bigmat_complex_6()
