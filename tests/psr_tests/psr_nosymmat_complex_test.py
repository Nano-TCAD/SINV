...
def test_psr_nosymmat_complex_1():
    matrice_size = 9
    blocksize    = 1
...
@pytest.mark.mpi(min_size=3)
def test_psr_nosymmat_complex_2():
    matrice_size = 18
    blocksize    = 2
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)
def test_psr_nosymmat_complex_3():
    matrice_size = 27
    blocksize    = 3
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)            
def test_psr_nosymmat_complex_4():
    matrice_size = 12
    blocksize    = 1
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)            
def test_psr_nosymmat_complex_5():
    matrice_size = 24
    blocksize    = 2
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)            
def test_psr_nosymmat_complex_6():
    matrice_size = 36
    blocksize    = 3
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)
def test_psr_nosymmat_complex_7():
    matrice_size = 256
    blocksize    = 8
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)        
def test_psr_nosymmat_complex_8():
    matrice_size = 240
    blocksize    = 10
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
@pytest.mark.mpi(min_size=3)            
def test_psr_nosymmat_complex_9():
    matrice_size = 144
    blocksize    = 12
    nblocks      = matrice_size // blocksize
    bandwidth    = np.ceil(blocksize/2)
...
if __name__ == '__main__':
    test_psr_nosymmat_complex_1()
    test_psr_nosymmat_complex_2()
    test_psr_nosymmat_complex_3()
    test_psr_nosymmat_complex_4()
    test_psr_nosymmat_complex_5()
    test_psr_nosymmat_complex_6()
    test_psr_nosymmat_complex_7()
    test_psr_nosymmat_complex_8()
    test_psr_nosymmat_complex_9()
