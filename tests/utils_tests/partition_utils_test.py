...
def test_get_partitions_indices(
    ...
    start_blockrows, partition_sizes, end_blockrows = partu.get_partitions_indices(n_partitions, total_size, partitions_distribution)
...
def test_get_local_partition_indices(
    ...
    start_blockrow, partition_size, end_blockrow = partu.get_local_partition_indices(current_partition, n_partitions, total_size, partitions_distribution)
